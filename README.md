...
| Realization | 6–9s. **WAIT… I GOT IT!** Moby lights up. *Adventure* is typed into the guess bar, Guess is pressed, then a "Pixel Perfect" badge and confetti | 4–7.7s. **WAIT… I GOT IT!**, then the Play screen slides in. The camera pushes in on the in-game keyboard as *Adventure* is typed, then pulls back out as Guess brings the blurred frame into focus and the badge lands | 4–7.7s. **WAIT… I GOT IT!**, the keyboard slides up over the clue cards, *Adventure* is typed and Guess brings the frame into focus |
